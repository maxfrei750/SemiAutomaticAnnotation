"""Source:
    https://github.com/tensorflow/models/blob/5c0617a8f3041bfa97db45748050b9c254cb95d6/research/object_detection/utils/ops.py


Utility ops tensorflow research models. Copied, so that we dont need to install the
whole package, which bloats the docker image.
"""
